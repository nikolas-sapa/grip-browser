...
const GLYPHS: Record<string, string[]> = {
  ...
  // "x" and "~" are not in the registry's set, and the headline ratio carries
  // both. A KPI that silently drops its unit reads as a bare number, and the
  // tilde is the part that says this figure is not exact.
